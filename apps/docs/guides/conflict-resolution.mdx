...
The server assigns global order. See [Sync protocol](/architecture/sync-protocol) for details.
...
| Collaborative text editing        | Use [Yjs CRDTs](/guides/collaborative-editing) instead                            |
...
- [Offline-First Patterns](/guides/offline-first): How mutations flow through the outbox.
- [Collaborative Editing](/guides/collaborative-editing): CRDT-based editing that avoids field-level conflicts.
- [sync-core Transactions API](/packages/core/transactions): Low-level transaction creation and management.
