...
| Collaborative text editing        | Use [Yjs CRDTs](collaborative-editing) instead                                    |
...
- [Offline-First Patterns](offline-first): How mutations flow through the outbox.
- [Collaborative Editing](collaborative-editing): CRDT-based editing that avoids field-level conflicts.
